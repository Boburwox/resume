...
const GitHubDashboard = dynamic(
  ...
  {
    loading: () => {
      // Import and dynamic load loader to keep initial bundle minimized
      const { GitHubLoading } = require("@/features/github/components/github-loading");
...
const ResumeSection = dynamic(
  ...
  {
    loading: () => {
      const { ResumeLoading } = require("@/features/resume/components/resume-loading");
...
const ContactSection = dynamic(
  ...
  {
    loading: () => {
      const { ContactLoading } = require("@/features/contact/components/contact-loading");
